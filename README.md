# Azure Functions scaffold for MCP SDK-based remote servers (TypeScript)
...
Follow instructions in the [mcp-sdk-functions-hosting-node repo](https://github.com/Azure-Samples/mcp-sdk-functions-hosting-node/tree/main?tab=readme-ov-file#prerequisites) to leverage this scaffold for hosting remote MCP servers. 
